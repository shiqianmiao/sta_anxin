'use strict';
var Chart = require('com/mobile/lib/chart/Chart.core.js');
...
var LineChart = function (etx, data, options) {
    return new Chart(etx).Line(data, options);
};
return LineChart;