...
// The Final Countdown
var Countdown = function(el, finalDate, callback, custormTime) {
    if(custormTime > PRECISION) {
        PRECISION = custormTime;
    }
    this.el = el;
    this.$el = $(el);
    this.interval = null;
...
$.fn.countdown = function() {
    ...
    return this.each(function() {
        ...
        if (instanceNumber !== undefined) {
            ...
            return new Countdown(this, argumentsArray[0], argumentsArray[1], argumentsArray[2]);
        }
    });
};
