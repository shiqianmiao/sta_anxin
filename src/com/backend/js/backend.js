...
function _initWidget (el) {
    ...
    if (!defer.requested) {
        require.async(['com/backend/js/widget/' + widgetType + '.js'], function (Widget) {
...
Backend.on = function (events, callback) {
...
Backend.off = function (events, callback) {
...
Backend.trigger = function (events) {
...
Backend.widget = function (el, name) {
...
Backend.template = function (str, data) {
...
// 提示框
require.async(['com/backend/js/widget/alert.js']);
