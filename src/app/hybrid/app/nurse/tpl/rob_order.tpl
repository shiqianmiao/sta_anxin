<% for(var i = 0; i < order_list.length; i++) { %>
    <li id="order_<%= order_list[i].id %>" class="per-order" data-widget="app/hybrid/app/nurse/js/rob_order.js#order" data-id="<%= order_list[i].id %>" data-remain="<%= order_list[i].remain_time %>">
