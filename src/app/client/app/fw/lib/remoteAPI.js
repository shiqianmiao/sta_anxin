    ...
    NativeAPI.invoke(
        ...
        function (err, deviceInfo) {
            ...
            switch (deviceInfo.env) {
                case 'test1' :
                    baseUrl = 'http://mobds.ganjistatic3.com/webapp/servicestore/';
                    break;
                case 'web6' :
                    baseUrl = 'http://mobtestweb6.ganji.com/webapp/servicestore/';
                    break;
                default:
                    baseUrl = 'http://mobds.ganji.cn/webapp/servicestore/';
            }
