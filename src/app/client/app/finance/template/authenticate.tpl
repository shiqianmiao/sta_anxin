...
<section class="renzheng">
    <!-- form start -->
    <form action="" id="form" data-disabled-submit="1" data-config-id="validatorConfig" data-widget="app/client/app/finance/widget/loan.js#authenticate">
        <div class="form-widget">
            <div class="form-tips">请如实填写方便客服联系到您！</div>
            <div class="form-group">
                <div class="form-field" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="real_name">
                    <div class="form-item">
                        <label class="form-label">姓　　名</label>
                        <div class="form-control" >
                            <label class="input-group">
                                <input data-role="input" name="real_name" value="<%= real_name %>" type="text" class="input-text" placeholder="2-4个汉字" />
                            </label>
                        </div>
                        <div class="form-warning" data-role="tipSpan"></div>
                    </div>
                </div>
                <div class="form-field" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="id_card" >
                    <div class="form-item" >
                        <label class="form-label">身份证号</label>
                        <div class="form-control">
                            <label class="input-group">
                                <input data-role="input" name="id_card" value="<%= id_card %>" type="text" class="input-text" placeholder="您的身份证号码" />
                            </label>
                        </div>
                        <div class="form-warning" data-role="tipSpan"></div>
                    </div>
                </div>
                <div class="form-field" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="city_domain">
                    <div class="form-item" >
                        <label class="form-label">城　　市</label>
                        <div class="form-control" >
                            <div class="filter-group search-group city-group" data-role="childSelect" data-widget="app/client/app/finance/widget/loan.js#showSelect">
                                <div data-widget="app/client/app/finance/widget/loan.js#searchCity">
                                    <input data-role="input" id="city_domain" name="city_domain" value="<%= city_domain %>" type="hidden" />
                                    <div class="filter-tips <% if(city_domain) { %> active <% } %>" data-role="text"><%= city_name || '请选择' %></div>
                                    <div class="filter-value"></div>
                                    <div class="filter-cont no-animation">
                                        <!-- <div class="filter-head">
                                            <label class="input-search-group">
                                                <input type="search" class="input-search js-input" placeholder="请输入您要搜索的关键字" />
                                            </label>
                                        </div> -->
                                        <div class="filter-head">
                ...
                <div class="form-field" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="jigou_type">
                    <div class="form-item" >
                        <label class="form-label">机构类型</label>
                        <div class="form-control" >
                            <div class="filter-group" data-role="childSelect" data-widget="app/client/app/finance/widget/loan.js#showSelect">
                                <div data-widget="app/client/app/finance/widget/loan.js#select">
                                    <input data-role="input" name="jigou_type" value="<%= jigou_type %>" type="hidden" />
                                    <div class="filter-tips <% if(jigouTypeName) { %> active <% } %>" data-role="text"><%= jigouTypeName || '请选择' %></div>
                                    <div class="filter-value"></div>
                                    <div class="filter-cont">
                                        <div class="filter-head">
                                            <h2 class="filter-title">机构类型</h2>
                                            <button class="filter-opt" data-role="cancel">取消</button>
                                        </div>
                                        <div class="filter-body">
                                            <div class="filter-wrap">
                                                <ul class="filter-menu">
                                                    <li data-value="1" class="js-touch-state">银行</li>
                                                    <li data-value="2" class="js-touch-state">小贷公司</li>
                                                    <li data-value="3" class="js-touch-state">担保公司</li>
                                                    <li data-value="4" class="js-touch-state">其他</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="form-field" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="jigou_id">
                    <div class="form-item" >
                        <label class="form-label">所属机构</label>
                        <div class="form-control" >
                            <div class="filter-group search-group" data-role="childSelect" data-widget="app/client/app/finance/widget/loan.js#showSelect" data-name="jigou_id">
                                <div data-widget="app/client/app/finance/widget/loan.js#searchFormAjax">
                                    <input data-role="input" name="jigou_id" value="<%= jigou_id %>"  type="hidden" />
                                    <div class="filter-tips <% if(jigou_id) { %> active <% } %>" data-role="text"><%= jigou_name  || '请选择' %></div>
                                    <div class="filter-value"></div>
                                    <div class="filter-cont">
                                        <div class="filter-head">
                                            <label class="input-search-group">
                                                <input type="search" class="input-search js-input" placeholder="请输入机构名称"/>
                                            </label>
                                            <button class="filter-opt" data-role="cancel">取消</button>
                                        </div>
                                        <div class="filter-body">
                                            <div class="filter-wrap">
                                                <ul class="filter-menu filter-ajax" data-role="suggestion"></ul>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="form-field" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="jigou_addr">
                    <div class="form-item" >
                        <label class="form-label">机构地址</label>
                        <div class="form-control" >
                            <label class="input-group">
                                <input data-role="input" name="jigou_addr" type="text" value="<%= jigou_addr %>" class="input-text" placeholder="区县+街道+门号牌" />
                            </label>
                        </div>
                        <div class="form-warning" data-role="tipSpan"></div>
                    </div>
                </div>
                <div class="form-field" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="jigou_phone">
                    <div class="form-item" >
                        <label class="form-label">机构电话</label>
                        <div class="form-control" >
                            <label class="input-group">
                                <input data-role="input" pattern="[\d]*" value="<%= jigou_phone %>" name="jigou_phone" type="text" class="input-text" placeholder="区号-电话号码-分机号" />
                            </label>
                        </div>
                        <div class="form-warning" data-role="tipSpan"></div>
                    </div>
            ...
            <div class="form-group upload-group">
                <div class="form-field" data-widget="app/client/app/finance/widget/loan.js#initUpload"
                     data-max-count="1"
                     data-default-img="http://stacdn201.ganjistatic1.com/src/image/mobile/touch/milan/pub/nopic.png"
                     data-server="http://image.ganji.com/"
                     data-upload-dir="jingrong">
                    <div class="form-item" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="img_front">
                        <label class="form-label">手持身份证正面</label>
                        <div class="form-control" data-role="images">
                            <div class="pic-group" data-role="addfile">
                                <i class="icon icon-photo">添加照片</i>
                                <input type="file" class="input-file" data-role="uploader" accept="image/*">
                                <input type="hidden" name="img_front" value='<%= img_front %>' data-role="input">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-field" data-widget="app/client/app/finance/widget/loan.js#initUpload"
                     ...
                     data-server="http://image.ganji.com/"
                     data-upload-dir="jingrong">
                    <div class="form-item" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="img_back" >
                        <label class="form-label">身份证反面</label>
                        <div class="form-control" data-role="images">
                            <div class="pic-group" data-role="addfile">
                                <i class="icon icon-photo">添加照片</i>
                                <input type="file" class="input-file" data-role="uploader" accept="image/*">
                                <input type="hidden" name="img_back" value='<%= img_back %>' data-role="input">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-field" data-widget="app/client/app/finance/widget/loan.js#initUpload"
                     ...
                     data-server="http://image.ganji.com/"
                     data-upload-dir="jingrong">
                    <div class="form-item" data-role="field" data-widget="app/client/app/finance/widget/loan.js#inputField" data-name="img_work">
                        <label class="form-label">工卡/名片</label>
                        <div class="form-control" data-role="images">
                            <div class="pic-group" data-role="addfile">
                                <i class="icon icon-photo">添加照片</i>
                                <input type="file" class="input-file" data-role="uploader" accept="image/*">
                                <input type="hidden" name="img_work" value='<%= img_work %>' data-role="input">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-opt">
                <button class="btn btn-primary btn-large js-touch-state">提交认证</button>
            </div>
        </div>
    </form>
