/* jshint ignore:start */
var $ = require('$');
require('./zepto.color.js');

function renderCrackEffectReflect(ctx, p1, p2, line, options) {
    var tx = line.tx,
        ty = line.ty,
    ...
    grd.addColorStop(0.5, clr.alpha(0.1).toRgbaString());
...
function renderCrackEffectFractures(ctx, p1, p2, line, options) {
    var tx = line.tx,
        ty = line.ty,
...
function renderCrackEffectMainLine(ctx, p1, p2, line, options) {
    var tx = line.tx,
        ty = line.ty,
...
function renderCrackEffectNoise(ctx, p1, p2, line, options) {
    var tx = line.tx,
        ty = line.ty,
...
function renderCrackEffectAll(ctx, center) {
    var paths, options;
    var i, len, line;
    ...
    for (i = 0, len = paths.length; i < len; i++) {
        ...
        renderCrackEffectReflect(ctx, line.p1, line.p2, line.desc);
        renderCrackEffectFractures(ctx, line.p1, line.p2, line.desc);
        renderCrackEffectMainLine(ctx, line.p1, line.p2, line.desc);
        renderCrackEffectNoise(ctx, line.p1, line.p2, line.desc);
    }
}
...
module.exports = {
    renderCrackEffectAll: renderCrackEffectAll,
};
/* jshint ignore:end */
