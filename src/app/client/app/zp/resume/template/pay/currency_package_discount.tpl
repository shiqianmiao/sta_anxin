                    ...
                    <li>
                        <label class="radio-group">
                            ...
                            <span><%=item.info.price%>元/<%=item.info.name%>
                                <%if(item.info.free_quantity >0){%>
                                <small class="tip">
                                    赠送
                                    <em>
                                    <%=item.info.free_quantity%>
                                    </em>个招聘币
                                ...
                                <%}else{%>
                                    <br>
                                <%}%>
                                <strong class="sale"><em><%=item.info.coin_unit_price%></em>元/个</strong>
                                <b class="cost"><%=item.info.origin_coin_unit_price%>元/个</b>
                            </span>
                        </label>
                    </li>
                <%});%>
